    ...
    <div className="bg-white bg-opacity-5">
      {animeDetails && (
        <div className="grid grid-flow-col auto-cols-auto gap-4">
          <div className="w-60 pt-16 pl-10">
          ...
          <div className="w-[calc((100vw*0.75)-20rem)] py-16 pr-16">
            <div className="flex gap-7">
              <a
                onClick={handelHome}
                className="text-gray-200 mb-4 cursor-pointer hover:text-pink-300"
              >
                Home
              </a>
              <div className="text-gray-400">{animeDetails.title_english}</div>
              <span className="text-gray-200 mb-4 cursor-pointer hover:text-pink-300">
                {animeDetails.duration.slice(0, 6)}
              </span>
            </div>
            <h2 className="text-4xl text-gray-200 font-sans font-bold mb-5">
              {animeDetails.title}
            </h2>
            ...
            <div className="flex">
              <div className="text-gray-200 mt-6 mr-8">
          ...
          <div className="w-[calc(100vw*0.25)] bg-white bg-opacity-10 py-16 px-8">

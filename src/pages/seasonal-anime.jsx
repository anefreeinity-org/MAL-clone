  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl">
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="flex items-center justify-center w-16 h-8 rounded-full border-2 border-gray-600 hover:border-white-800 text-gray-200 text-sm font-semibold font-sans cursor-pointer hover:bg-gray-700 transition">
          view all
        </div>
      </div>
